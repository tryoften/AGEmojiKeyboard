...
backSpaceButtonImage:(UIImage *)backSpaceButtonImage
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(backToKeyboardSegmentPressed:) name:@"BackToKeyboardSegmentPressed" object:nil];
    return self;
}

- (void) backToKeyboardSegmentPressed:(NSNotification *) notification {
